...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-bg-secondary border-r border-border flex flex-col">
      {/* Logo */}
      <div className="p-6 border-b border-border">
        <a href="/" className="flex items-center gap-2 text-xl font-bold">
          ...
          <span className="text-white">Tokencap</span>
        </a>
      </div>
      ...
      <div className="p-4 border-t border-border">
        <a
          href="https://github.com/tokencap/tokencap"
          target="_blank"
